...
$PgTitleTxtList[4]="4. Geef de zijden met een staander aan";
$PgTitleTxtList[5]="5. Geef de zijden met een plint of achterwand aan";
$PgTitleTxtList[6]="6. Overige toebehoren";
$PgTitleTxtList[7]="TODO. Berekening offerte"; //TODO
$PgTitleTxtList[8]="7. Invoer contactgegevens en verzending";
...
$PgNavTxtList[4]="staanders";
$PgNavTxtList[5]="achterwanden of plinten";
$PgNavTxtList[6]="overige toebehoren";
$PgNavTxtList[7]="TODO. berekening"; //TODO
$PgNavTxtList[8]="contactgegevens en verzending";
                ...
                <div class="content">
                    ...
                    do {
                        ...
                        switch ($page) {
                            ...
                            case 4: //page 4, invoer staanders van model.
                            case 5: //page 5, invoer achterwanden/plinten van model.
                            case 6: //page 6, invoer overige.
                            case 8: //page 7, invoer contactgegevens
                                ...
                                if ($PgFldList[$page]>"") {
                                    ...
                                    foreach ($flds as $fld) {
                                        ...
                                        if ($page==2 || $page==3 || $page==4 || $page==5) $arrTabItems=$arrTabItems_Shape;
                                        if ($page==6 && ($fld=="off_spoelbakuitsparing" || $fld=="off_spoelbaklevering" || $fld=="off_spoelbaktype")) $arrTabItems=$arrTabItems_Spoelbak;
                                        if ($page==6 && ($fld=="off_aantalgaten" || $fld=="off_kraanlevering" || $fld=="off_kraantype")) $arrTabItems=$arrTabItems_Kraan;
                                ...
                                //form fields
                                if (($page==1 && $mode!="html") || $page>5) {
                                    if ($page==6 && $mode=="html") $ContentPg[$page].='<div style="position:relative;display:block;">'.PHP_EOL;
                                    $ContentPg[$page].='<table cellpadding="4" cellspacing="0">'.PHP_EOL;
                                }
                                foreach($PgFldList as $pg=>$FldList) {
                                    if ($FldList>"") {
                                        ...
                                        foreach ($flds as $fld) {
                                            ...
                                            if ($pg==2 || $pg==3 || $pg==4 || $pg==5) $arrTabItems=$arrTabItems_Shape;
                                            if ($pg==6 && ($fld=="off_spoelbakuitsparing" || $fld=="off_spoelbaklevering" || $fld=="off_spoelbaktype")) $arrTabItems=$arrTabItems_Spoelbak;
                                            if ($pg==6 && ($fld=="off_aantalgaten" || $fld=="off_kraanlevering" || $fld=="off_kraantype")) $arrTabItems=$arrTabItems_Kraan;
                                            if ($pg==$page) {
                                                if (($pg==4 && $mode=="html" && $fld=="off_staander") ||
                                                    ($pg==5 && $mode=="html" && $fld=="off_achterwand_plinten")) { //field having own div block
                                                    $ContentPg[$page].='<div style="position:relative;display:block;">'.PHP_EOL;
                                                    $ContentPg[$page].='<table cellpadding="4" cellspacing="0">'.PHP_EOL;
                                                }
                                                if ($pg==6 && $mode=="html" && ($fld=="off_aantalgaten" || $fld=="off_inmeten")) { //field followed just after field off_spoelbaktype or off_kraantype (having own div block)
                                                    $ContentPg[$page].='<div style="position:relative;display:block;">'.PHP_EOL;
                                                    $ContentPg[$page].='<table cellpadding="4" cellspacing="0">'.PHP_EOL;
                                                    $ContentPg[$page].='<tr>'.PHP_EOL;
                                                ...
                                                fnc_FldDef($mode, $arrTabItems, $PgFldVal, $page, $fld, $result, $msg, $ContentPg);
                                                if (($pg==4 && $mode=="html" && $fld=="off_staander") ||
                                                    ($pg==5 && $mode=="html" && $fld=="off_achterwand_plinten")) {
                                ...
                                if ($page==6 && $mode=="html") $ContentPg[$page].='</div>'.PHP_EOL;
                                if ($mode=="html") {
                                    //if ($page==1) {
                            ...
                            case 7: //page 6, berekening offerte
                            ...
                            case 9: //final page, check all and send input, display confirmation page whether error/succesful processed
                    ...
                    if ($page==6 & $mode=="html") { //special fields on tab page to set focus to a tab content item
                        $fld_spoelbaklevering="off_spoelbaklevering";
                        $val_spoelbaklevering=$PgFldVal[$page][$fld_spoelbaklevering];
                        $fld_spoelbaktype="off_spoelbaktype";
                        $val_spoelbaktype=$PgFldVal[$page][$fld_spoelbaktype];
