...
$action="./offertenew.php"; //submit request is deze page
...
//                            ),
                        ...
                        switch ($fld) {
                            ...
                            case "off_blad1_lengte":
                                ...
                                if ($fld=="off_blad1_lengte") {
                                    ...
                                    if ($mode=="html") {
                                        ...
                                        //($val_materiaal=="Hplhout" || $val_materiaal == "Hpluni" || $val_materiaal == "Hplfantasie")
                            ...
                            case "off_abs":
                                ...
                                if($type == 'haaks' && ($val_materiaal == "Hplfantasie" || $val_materiaal == "Hplhout" || $val_materiaal == "Hpluni"))
                                {
                                    $val=$PgFldVal[$page][$fld];
                                    if ($mode=="init" || $mode=="ctrl") {
                                        $msg[$fld]="";
                            ...
                            */
                            ...
                            case "off_kookplaatuitsparing":
                                ...
                                if ($mode=="html") {
                                    ...
                                    if ($val_materiaal!="Hplfantasie" || $val_materiaal!="Hplhout" || $val_materiaal!="Hpluni") {
                                        $ContentPg[$page].='<tr height="10px"><td colspan="2"></td></tr>'.PHP_EOL;
                    ...
                    do {
                        ...
                        switch ($page) {
                            ...
                            case 10: //final page, check all and send input, display confirmation page whether error/succesful processed
                                ...
                                $email_attachments=array(0=>"./offertenew.php",1=>"./images/ok.png"); //TEST
